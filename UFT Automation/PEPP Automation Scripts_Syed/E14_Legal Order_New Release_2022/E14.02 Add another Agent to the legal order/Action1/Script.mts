...
browser("name:=Login").Page("title:=Login").webedit("name:=j_password").Set "Summer!2022"
...
Obj.WebEdit("xpath:=//h1[text()='Search Parameters']//following::input[1]").Set "238237"         'Stakeholder Id' "284736"
browser("name:=Penfax 5").Sync

'Obj.WebList("xpath:=//label[text()='Member Status']//following::select[1]").Select "Active"   'Member Status
Obj.WebList("xpath:=//label[text()='Member Status']//following::table[2]/tbody[1]/tr[1]/td[1]/span[1]/select[1]").Select "Active"   'Member Status
wait(2)
...
''PROPERTY VALUE CHANGED''''''''''Obj.WebElement("xpath:=//h1[@class='xxc' and text()='Legal Order']//following::span[1]").Click
Obj.WebElement("xpath:=//h1[@class='xxc' and text()='Legal Orders']//following::span[1]").Click


''Step 3 - Selecting Values in the Legal Order (PLEASE NOTE: CHANGES MADE TO THE COMPLETE STEP 3)
...
Obj.WebEdit("xpath:=//a[@class='xi3' and @title='Select Date']//preceding::input[1]").Set strNewPmtDate 'strPayDate1
...
'Step 6 - Click on Legal Order "EDIT" Button
Obj.WebElement("xpath:=//h1[@class='xxc' and text()='Legal Orders']//following::span[2]").Click
wait(2)
browser("name:=Penfax 5").Sync
''Step 6.1 - Edit Values in the Legal Order
Obj.WebList("xpath:=//div[@class='x1h9' and text()='Legal Order']//following::select[1]").Select "Public Trustee"   'Legal Order Type" Value
Obj.WebList("xpath:=//div[@class='x1h9' and text()='Legal Order']//following::select[2]").Select "Majority"   'Selecting "Co-Agent Decision Authority" Value
Obj.WebList("xpath:=//div[@class='x1h9' and text()='Legal Order']//following::select[3]").Select "All"   'Selecting "Co-Agent Signature" Value
Obj.WebList("xpath:=//div[@class='x1h9' and text()='Legal Order']//following::select[4]").Select "Principal Alone"   'Selecting "Communication Directive" Value
'Obj.WebElement("xpath:=//span[@class='xfx' and text()='Save']").Click 'click on save

'Obj.WebElement("xpath:=//span[@class='xfx' and text()='Save']").Click 'click on Save
Browser("Penfax 5").Page("Penfax 5").WebButton("Save").Click
