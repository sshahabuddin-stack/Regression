...
'Purpose : This scripts is to test "Add a Legal Order".
...
browser("name:=Login").Page("title:=Login").webedit("name:=j_password").Set "Winter@2023"
...
strPayDate1 = Datatable("PayDate1","Flight")
...
Obj.WebEdit("xpath:=//h1[text()='Search Parameters']//following::input[1]").Set "238237"        'Stakeholder Id'
...
Obj.WebElement("xpath:=//span[text()='Save']").Click 'clcik on save
wait(3)
browser("name:=Penfax 5").Sync
...
Obj.WebElement("xpath:=//div[@class='x1h9' and text()='Agent']//following::span[19]").Click 'clcik on save
