...
public class PenwebLumpsumWithdrawal {
	...
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("//input[@id='form-component-5']")).sendKeys("1250");
	    driver.findElement(By.xpath("//input[@id='form-component-7']")).sendKeys("1250");
	    driver.findElement(By.xpath("//button[@class='mx-1 btn pw-button btn-primary']")).click();
